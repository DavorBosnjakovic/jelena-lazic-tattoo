      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto prose prose-lg prose-headings:font-heading prose-headings:font-bold prose-h2:text-3xl prose-h3:text-2xl prose-p:text-foreground/90 prose-p:font-body prose-ul:font-body prose-a:text-accent hover:prose-a:text-accent/80">
          ...
          <section className="mb-12">
            ...
            <p>
              Information you send through the contact form is delivered to us as email via Resend
              (email service). We implement appropriate technical and organizational
          ...
          <section className="mb-12">
            ...
            <ul>
              <li>
                <strong>Resend:</strong> Email delivery service for contact form messages
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <ul>
              <li><strong>Contact Form Messages:</strong> Retained in our email inbox for business records</li>
